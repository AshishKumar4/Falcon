...
#if defined(HMC5883) || defined(HMC5843) || defined(AK8975) || defined(MAG3110) || defined (QMC5883) || defined (MPU9250_MAG)
  #define MAG 1
#else
  #define MAG 0
#endif
...
#if !defined(SERIAL_SUM_PPM) && !defined(SPEKTRUM) && !defined(SBUS) && !defined(SUMD) && !defined(SPI_RX) && !defined(I2C_RX)
  #define STANDARD_RX
#endif
...
#ifdef SPI_RX
  #if (!defined(PROMINI))
    #error "Currently SPI RX is only supported for ATmega328P"
  #endif
  #if (!defined(QUADX) && !defined(QUADP) && !defined(Y4) && !defined(TRI))
    #error "Currently SPI RX is only supported for QUADX, QUADP, Y4 or TRI configurations"
  #endif
#endif
*/
#endif /* DEF_H_ */
