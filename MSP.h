...
#define MSP_SPI_PROT_SPI_RX_V202_250K 0
#define MSP_SPI_PROT_SPI_RX_V202_1M   1
#define MSP_SPI_PROT_SPI_RX_SYMA_X    2
#define MSP_SPI_PROT_SPI_RX_SYMA_X5C  3
#define MSP_SPI_PROT_SPI_RX_CX10      4
#define MSP_SPI_PROT_SPI_RX_CX10A     5
#define MSP_SPI_PROT_SPI_RX_H8_3D     6
#define MSP_SPI_PROT_SPI_RX_INAV      7
